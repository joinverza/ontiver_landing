...
export const moduleCards: ModuleCard[] = [
  {
    ...
    description: "Supports document, biometric, and MFA verification with audit logs.",
  ...
  },
  {
    ...
    description: "Verified identity is stored as portable proof for returning users.",
  ...
  },
  {
    ...
    description: "Central dashboard for verification logs, consent, and compliance reports.",
