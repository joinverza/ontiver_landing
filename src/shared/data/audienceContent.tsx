...
import type { UseCaseCard } from "../../features/enterprise/use-cases/data/useCases";
...
export const individualProblems: ProblemItem[] = [
  {
    ...
    illustration: (
      <img src="/assets/rep-prob.png" alt="" className="h-full w-full bg-black/5 object-cover" />
    ),
  },
  {
    ...
    illustration: (
      <img src="/assets/ont-prob.png" alt="" className="h-full w-full bg-black/5 object-cover" />
    ),
  },
  {
    ...
    illustration: (
      <img src="/assets/ver-prob.png" alt="" className="h-full w-full bg-black/5 object-cover" />
    ),
  },
];
...
export const individualSolutionSteps: SolutionStep[] = [
  ...
  {
    icon: "/assets/consent.svg",
    title: "Approve the next share",
    para: "Reuse your proof with a new request instead of starting over.",
  },
  {
    icon: "/assets/reuse.svg",
    title: "Manage your history",
    para: "Review, revoke, or check on anything you've ever shared.",
  },
];
...
export const individualModuleCards: ModuleCard[] = [
  ...
  },
  {
    ...
    copyClassName:
      "top-[72px] bottom-auto left-5 max-w-[250px] sm:top-[100px] sm:left-7 sm:max-w-[284px]",
...
export const individualSecurityFeatures: SecurityFeature[] = [
  ...
  },
  {
    ...
    description:
      "Keep verification and sharing activity together instead of guessing where your data went.",
  ...
  },
  {
    ...
    description:
      "Reduce repeated identity collection where a supported service can accept an existing proof.",
