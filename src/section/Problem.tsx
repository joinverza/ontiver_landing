...
const problems = [
  {
    ...
    illustration: <img src="./assets/rep-prob.png" alt="rep-image" className="w-full h-full object-cover bg-black/5" />,
  },
  {
    ...
    illustration: <img src="./assets/ont-prob.png" alt="ont-image" className="w-full h-full object-cover bg-black/5" />,
  },
  {
    ...
    illustration: <img src="./assets/ver-prob.png" alt="ver-image" className="w-full h-full object-cover bg-black/5" />,
  },
];
