...
const PricingHero = ({ billingCycle, onBillingChange }: PricingHeroProps) => {
  return (
      ...
      <div className="site-container grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
        <div data-scroll-reveal className="min-w-0">
          ...
          <p className="mt-6 max-w-[560px] text-subtitle text-[#526052]">
            Choose a starting point for your workflow. Prices, allowances, and service terms are
          ...
          <div className="mt-9 flex flex-wrap items-center gap-4">
            ...
            <span aria-live="polite" className="text-meta font-medium text-[#007d21]">
              Request a {billingCycle === "annual" ? "yearly" : "monthly"} quote
            </span>
          </div>
          <p className="mt-6 max-w-[560px] text-sm text-[#637060]">
            Your billing preference is included when you request a quote. No rates or annual
