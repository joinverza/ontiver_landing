...
const UseCaseEvaluation = ({ measures }: { measures: UseCasePageDetail["evaluationMeasures"] }) => {
  return (
    <section aria-labelledby="evaluation-heading" className="section-space bg-[#edf5e7]">
      <div className="site-container grid gap-12 lg:grid-cols-2 lg:gap-20">
        <div data-scroll-reveal>
          <p className="eyebrow">Proposed evaluation measures</p>
          <h2 id="evaluation-heading" className="mt-5 text-section font-normal">
...
export default UseCaseEvaluation;
