...
export default function ProblemCard({
  ...
  return (
    <div
      className="group relative isolate flex flex-col gap-2 overflow-hidden rounded-[20px] border border-black/5 bg-white p-0.5 shadow-xl transition-[transform,border-color,box-shadow,background-color] duration-[320ms] ease-[cubic-bezier(0.22,1,0.36,1)] will-change-transform [--anim-speed:1] [--mx:50%] [--my:50%] [--rx:0deg] [--ry:0deg] [--tx:0px] [--ty:0px] [transform:perspective(900px)_rotateX(var(--rx))_rotateY(var(--ry))_translateY(0)_scale(1)] hover:border-light-primary hover:bg-[#fbfffb] hover:[--anim-speed:1.85] hover:[transform:perspective(900px)_rotateX(var(--rx))_rotateY(var(--ry))_translateY(-10px)_scale(1.018)]"
