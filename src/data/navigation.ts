...
export const enterpriseNavLinks: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: "Recruitment & HR", to: "/enterprise/use-cases/hr-platforms", description: "Credentials and references.", icon: BriefcaseBusiness },
      { name: "Logistics & delivery", to: "/enterprise/use-cases/logistics-delivery", description: "Drivers, licences and renewals.", icon: ListChecks },
