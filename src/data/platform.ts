...
export const platformLayers: PlatformLayer[] = [
  {
    ...
    description: "Connect to trusted sources: NIN, BVN, phone, documents, biometrics, licenses, institutions, employers, referees.",
    icon: Fingerprint,
    ...
    boundary: "NIN/BVN are the initial focus. Additional sources are scoped by pilot, provider access, and market requirements.",
    relatedIds: ["verification-engine","workflow-engine","intelligence","consent-and-privacy","identity-proofs"],
  },
  {
    id: "verification-engine",
    title: "Verification engine",
    description: "Run identity, document, face, liveness, certificate, employment, reference, and business checks — normalized into one result.",
    icon: ScanSearch,
    ...
    boundary: "Confirm the available checks during pilot scoping. Uncertain results need review; an upload alone does not establish authenticity.",
    relatedIds: ["identity-sources","workflow-engine","intelligence","consent-and-privacy","identity-proofs"],
  },
  {
    id: "workflow-engine",
    title: "Workflow engine",
    description: "Connect checks to your business process: ordered steps, conditions, retries, approvals, manual review, expiry.",
    icon: GitBranch,
    ...
    relatedIds: ["identity-sources","verification-engine","intelligence","consent-and-privacy","identity-proofs"],
  },
  {
    id: "intelligence",
    title: "Intelligence",
    description: "Explainable signals: OCR, tamper detection, cross-source consistency, duplicate detection, risk indicators.",
    icon: Sparkles,
    ...
    workflow: [
      ...
      },
      {
        ...
        "description": "Signals are attached to the case for reviewer context — never used to auto-decide alone."
      }
    ],
    boundary: "Intelligence is a phased capability. Signals inform human review; a mismatch or duplicate is not proof of fraud.",
    relatedIds: ["identity-sources","verification-engine","workflow-engine","consent-and-privacy","identity-proofs"],
  },
  {
    id: "consent-and-privacy",
    title: "Consent and privacy",
    description: "Control what's shared: purpose, scope, approval, decline, retention, revocation, sharing history.",
    icon: ShieldCheck,
    ...
    workflow: [
      ...
      },
      {
        ...
        "description": "The event is logged to sharing history, with revocation available at any time."
      }
    ],
    boundary: "Revocation limits future access; retention and legal duties may still apply.",
    relatedIds: ["identity-sources","verification-engine","workflow-engine","intelligence","identity-proofs"],
  },
  {
    id: "identity-proofs",
    title: "Identity proofs",
    description: "Create reusable claims: proof creation, validation, expiration, revocation, selective disclosure.",
    icon: BadgeCheck,
    ...
    relatedIds: ["identity-sources","verification-engine","workflow-engine","intelligence","consent-and-privacy"],
  },
];
