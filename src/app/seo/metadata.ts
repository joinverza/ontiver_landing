...
export function getSeoMeta(pathname: string): SeoMeta {
  ...
  const layer = platformMatch
    ? platformLayers.find((item) => item.id === platformMatch[1])
    : undefined;
  if (layer) {
    return {
  ...
  const staticMeta: Record<string, Omit<SeoMeta, "canonicalPath" | "structuredData">> = {
    "/identity": {
      ...
      description:
        "Explore reusable identity proof designed around your permission, with fewer repeated document uploads across supported businesses.",
      image: DEFAULT_IMAGE,
      type: "website",
    },
    "/how-it-works": {
      ...
      description:
        "See the journey from verification to reusable proof, reviewing requests, and choosing what to share with supported services.",
      image: DEFAULT_IMAGE,
      type: "website",
    },
    "/use-cases": {
      ...
      description:
        "Explore how reusable identity can support banking, lending, marketplaces, work, education, and everyday services.",
      image: DEFAULT_IMAGE,
      type: "website",
    },
    "/waitlist": {
      ...
      description:
        "Join the Ontiver waitlist for early access updates about reusable identity and sharing on your terms.",
      image: DEFAULT_IMAGE,
      type: "website",
    },
    "/resources": {
      ...
      description:
        "Explore guides, privacy information, and support for understanding your identity proof and sharing choices.",
    ...
    "/enterprise/resources": {
      ...
      description:
        "Find identity verification, KYC, consent, and integration guides for product, engineering, and compliance teams.",
    ...
    "/enterprise/platform": {
      ...
      description:
        "Explore the six Ontiver platform layers connecting identity sources, verification, workflows, intelligence, consent, and reusable proof.",
      image: `${SITE_URL}${imagery.candidateReview.src}`,
      type: "website",
    },
    "/enterprise/use-cases": {
      ...
      description:
        "Explore identity workflows for fintechs, lenders, marketplaces, HR platforms, education, and compliance teams.",
      image: ENTERPRISE_IMAGE,
      type: "website",
    },
    "/enterprise/security": {
      ...
      description:
        "Explore consent controls, data handling, access, audit records, and security review topics for your Ontiver pilot.",
      image: ENTERPRISE_IMAGE,
      type: "website",
    },
    "/enterprise/support": {
      ...
      description:
        "Contact Ontiver Support about verification, integration, billing, and other enterprise questions through a private support conversation.",
      image: ENTERPRISE_IMAGE,
      type: "website",
    },
    "/security": {
      ...
      description:
        "Explore Ontiver's approach to consent, controlled identity sharing, data minimization, and enterprise security review.",
      image: DEFAULT_IMAGE,
      type: "website",
    },
    "/": {
    ...
    "/account-deletion": {
      ...
      description:
        "Initiate deletion of an Ontiver account through the app or a secure email-verified web flow.",
      image: DEFAULT_IMAGE,
      type: "website",
    },
    "/legal": {
